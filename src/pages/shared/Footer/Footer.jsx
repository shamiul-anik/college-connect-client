      ...
      <div className="footer p-8 pb-4 md:pt-12 md:pb-8 max-w-7xl mx-auto grid gap:8 lg:gap-18 lg:grid-cols-5">
        <div className="col-span-2">
          <Link to="/" className="flex gap-3 items-center text-3xl text-slate-50 font-bold">
            ...
            <span className='flex items-center banner-highlighted-text !text-2xl md:!text-3xl'>College Connect</span>
          </Link>
          <p className="text-justify mt-2 mb-2">
            Discover Your Academic Journey: College Connect - Where Aspirations Find Their Path to Success!
          </p>
          {/* <p className='text-justify mb-2'>
            Open New Horizons: Immerse Yourself in the Art of Language at College Connect – Where Fluency Fuels Boundless Connections!
          </p> */}
          <header>
        ...
        <div className='col-span-1 md:ml-8'>
          <span className="footer-title text-lg">About College</span>
        ...
        <div className='col-span-2'>
          ...
          <p className='flex gap-2 items-center font-normal mt-1'>
            ...
            <span className='text-slate-300'>info@college-connect.com</span>
          </p>
          <p className='flex gap-2 items-center font-normal mt-1'>
