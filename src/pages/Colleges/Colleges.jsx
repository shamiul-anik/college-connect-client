...
const Colleges = () => {
  ...
  return (
    <div>
      ...
      <ReactHelmet documentTitle="College Connect | Colleges" metaDescription="Colleges"></ReactHelmet>

      {/* Colleges Page Banner */}
      <CommonBanner bannerHeading="Colleges"></CommonBanner>
      ...
      <section className="max-w-7xl mx-auto mt-4 lg:mt-8 p-4 md:px-0">
        ...
        <SectionTitle heading="Colleges" subHeading="Explore Our Diverse Colleges"></SectionTitle>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-8 mt-8">
          {
            allColleges?.map((college) => <CollegeCard key={college._id} college={college}></CollegeCard>)
          }
        </div>
      </section>
    </div>
